  ...
  return (
    <button className='close-icon' onClick={onCloseClick}>
      <svg className='close-icon' width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M7 17L16.9 7.1" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M7 7L16.9 16.9" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>
    </button>
  )
}
